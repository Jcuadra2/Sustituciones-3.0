...
<body>
    ...
    <div id="titulo">
        <h1>Registrar Sustituciones</h1>
    </div>
    <div id="menu">
        <ul>
            <li><a href="" style="text-decoration:none;color:black">Registro de Sustituciones</a></li>
        </ul>
    </div>
    <div id="contenido">
        <?php
            ...
            if($num>0){
                ...
                while($fila=$conexion->resultado->fetch_array()){
                    echo '<form name="formu" action="updt_delt_profesor_frm.php" method="post" autocomplete="off">';
                        ...
                        echo '<input type="submit" name="accion" value="Asignar" id="btn_cs">';
